...
#ifndef INC_GMCP2515_H_
#define INC_GMCP2515_H_
...
class MCP2515
{
    ...
    public:
        MCP2515(SPI_HandleTypeDef* _SPI_CAN, const uint32_t _SPI_TIMEOUT, GPIO_TypeDef* _CS_Port, const uint8_t _CS_Pin);
        ERROR reset(void);
        ERROR setConfigMode();
